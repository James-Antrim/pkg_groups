...
if ($saveOrder and !empty($this->items)) {
	$saveOrderingUrl = 'index.php?option=com_groups&task=Roles.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
	HTML::_('draggablelist.draggable');
}
?>
<form action="<?php echo Route::_('index.php?option=com_groups&view=' . $this->_name); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
