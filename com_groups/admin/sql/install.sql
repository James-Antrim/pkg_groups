...
VALUES (1, 'text', '{"maxlength":"255","hint":"","regex":"simple_text"}'),
       (2, 'editor', '{"buttons":1,"hide":"ebevent,ebregister,groups_profiles,snippets,betterpreview,sliders,thmvcard,thmcontact,widgetkit,module,menu,contact,fields,jresearch_automatic_bibliography_generation,jresearch_automatic_citation,modals,pagebreak,readmore"}'),
...
ALTER TABLE `#__groups_role_associations`
  ADD CONSTRAINT `roleassociations_roleid` FOREIGN KEY (`roleID`) REFERENCES `#__groups_roles` (`id`)
  ON DELETE CASCADE
  ON UPDATE CASCADE,
